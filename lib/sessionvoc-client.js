...
function Client (options) {
  ...
  // FIXME: DRY duplication of defaultvals 
...
Client.prototype.loadInfo = function (fn) {
  ...
  this._request(
    ...
    function (err, data) {
      ...
      self.datainfo = JSON.parse(data); // TODO: should this be JSON.parsed?
...
/**
 * Creates a new session. Takes a callback function fn(err, sid) that will be passed a session-id. 
 *
 * @param {function} next
 */
